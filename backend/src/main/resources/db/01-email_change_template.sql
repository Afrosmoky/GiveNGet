insert into mail_templates (name, template)  value ('email-change', '<!DOCTYPE html>
<html lang="pl">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Potwierdzenie Zmiany Adresu Email</title>
    <style>
        body {
...
<body>
    <table>
        <tr>
            <td>
                <h1>Twój adres email został zmieniony!</h1>
                <p>Jeśli to Ty dokonałeś tej zmiany, możesz zignorować tę wiadomość. Twoje konto jest bezpieczne.</p>
                <p style="color: #cc0000; font-weight: bold;">Jeśli jednak nie Ty zmieniłeś zmieniłeś adres email, prosimy o natychmiastowy kontakt z administratorem w celu zabezpieczenia konta.</p>
